...
function findWasmBinary() {
  return locateFile('HydroSim.wasm');
}
...
var ASM_CONSTS = {
  92616: () => { if (document.fullscreenElement) return 1; },  
 92662: () => { return Module.canvas.width; },  
 92694: () => { return parseInt(Module.canvas.style.width); },  
 ...
 92888: () => { return Module.canvas.width; },  
 92920: () => { return screen.width; },  
 92945: () => { document.exitFullscreen(); },  
 92972: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 93105: () => { return window.innerWidth; },  
 93131: () => { return window.innerHeight; },  
 93158: () => { if (document.fullscreenElement) return 1; },  
 93204: () => { return Module.canvas.width; },  
 93236: () => { return parseInt(Module.canvas.style.width); },  
 93284: () => { if (document.fullscreenElement) return 1; },  
 93330: () => { return Module.canvas.width; },  
 93362: () => { return screen.width; },  
 93387: () => { return window.innerWidth; },  
 93413: () => { return window.innerHeight; },  
 93440: () => { if (document.fullscreenElement) return 1; },  
 93486: () => { return Module.canvas.width; },  
 93518: () => { return screen.width; },  
 93543: () => { document.exitFullscreen(); },  
 93570: () => { if (document.fullscreenElement) return 1; },  
 93616: () => { return Module.canvas.width; },  
 93648: () => { return parseInt(Module.canvas.style.width); },  
 93696: () => { document.exitFullscreen(); },  
 93723: ($0) => { Module.canvas.style.opacity = $0; },  
 93761: () => { return screen.width; },  
 93786: () => { return screen.height; },  
 93812: () => { return window.screenX; },  
 93839: () => { return window.screenY; },  
 93866: () => { return window.devicePixelRatio; },  
 93902: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 93955: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 94006: () => { Module.canvas.style.cursor = 'none'; },  
 94043: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 94299: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 94350: () => { if (document.pointerLockElement) return 1; },  
 94397: () => { if (document.fullscreenElement) return 1; },  
