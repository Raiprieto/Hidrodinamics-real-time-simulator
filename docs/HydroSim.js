...
var ASM_CONSTS = {
 ...
 93094: () => { document.exitFullscreen(); },  
 93121: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 93194: () => { if (document.fullscreenElement) return 1; },  
 93240: () => { return Module.canvas.width; },  
 93272: () => { return screen.width; },  
 93297: () => { document.exitFullscreen(); },  
 93324: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 93457: () => { return window.innerWidth; },  
 93483: () => { return window.innerHeight; },  
 93510: () => { if (document.fullscreenElement) return 1; },  
 93556: () => { return Module.canvas.width; },  
 93588: () => { return parseInt(Module.canvas.style.width); },  
 93636: () => { if (document.fullscreenElement) return 1; },  
 93682: () => { return Module.canvas.width; },  
 93714: () => { return screen.width; },  
 93739: () => { return window.innerWidth; },  
 93765: () => { return window.innerHeight; },  
 93792: () => { if (document.fullscreenElement) return 1; },  
 93838: () => { return Module.canvas.width; },  
 93870: () => { return screen.width; },  
 93895: () => { document.exitFullscreen(); },  
 93922: () => { if (document.fullscreenElement) return 1; },  
 93968: () => { return Module.canvas.width; },  
 94000: () => { return parseInt(Module.canvas.style.width); },  
 94048: () => { document.exitFullscreen(); },  
 94075: ($0) => { Module.canvas.style.opacity = $0; },  
 94113: () => { return screen.width; },  
 94138: () => { return screen.height; },  
 94164: () => { return window.screenX; },  
 94191: () => { return window.screenY; },  
 94218: () => { return window.devicePixelRatio; },  
 94254: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 94307: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 94358: () => { Module.canvas.style.cursor = 'none'; },  
 94395: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 94651: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 94702: () => { if (document.pointerLockElement) return 1; },  
 94749: () => { if (document.fullscreenElement) return 1; },  
